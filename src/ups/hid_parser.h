...
/* Common usages — Power Device page (0x84) */
...
#define HID_USAGE_AC_PRESENT             0x0065
#define HID_USAGE_REMAINING_CAPACITY     0x0066
#define HID_USAGE_RUNTIME_TO_EMPTY       0x0068

/* Common usages — Battery page (0x85) */
...
/* Common usages — APC vendor page (0xFF86) */
#define HID_USAGE_APC_SENSITIVITY        0x0061
#define HID_USAGE_APC_PANELTEST          0x0052
#define HID_USAGE_APC_FORCE_SHUTDOWN     0x0024
#define HID_USAGE_APC_STATUS_FLAG        0x0042
